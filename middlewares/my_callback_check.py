...
class MyCallbackCheckMiddleware(BaseMiddleware):
    ...
    async def get_random_restriction_text(self):
        ...
        texts = [
            ...
            "Кнопка в отпуске. Вернётся через ∞ дней.",
            ...
            "Не нажимай — иначе твой автомобиль научится дрифтовать без тебя.",
